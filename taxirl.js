...
function initActors() {
    ...
    for (var e = 0; e < ACTORS; e++) {
        ...
        } while (map[actor.y][actor.x] == 'B' || actorMap[actor.y + "_" + actor.x] != null);
...
function drawActors() {
    for (var a in actorList) {
        if (actorList[a] != null && actorList[a].hp > 0)
            asciidisplay[actorList[a].y][actorList[a].x].content = a == 0 ? '' + player.hp : 'c';
    }
}
